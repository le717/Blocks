...
class Ui_aboutDiag(object):
    def setupUi(self, aboutDiag):
        ...
        aboutDiag.resize(367, 318)
        aboutDiag.setMinimumSize(QtCore.QSize(0, 0))
...
"QLabel { qproperty-alignment: AlignCenter; }")
        ...
        self.lbCreated.setGeometry(QtCore.QRect(120, 50, 121, 41))
        ...
        self.lbHeader.setGeometry(QtCore.QRect(110, 20, 141, 21))
        ...
        self.btnClose.setGeometry(QtCore.QRect(140, 280, 75, 23))
        self.btnClose.setText("Close")
        self.btnClose.setObjectName("btnClose")
        self.appLogo = QtWidgets.QFrame(aboutDiag)
        self.appLogo.setGeometry(QtCore.QRect(110, 100, 141, 101))
